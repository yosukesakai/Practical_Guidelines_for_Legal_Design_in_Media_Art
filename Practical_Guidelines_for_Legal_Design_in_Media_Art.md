...
プロジェクトのコンセプトの促進のために、時にはコンセプトの設計に関与しながら、法的な事項を設計する。法的な側面からプロジェクトの実施環境をデザインし、必要であれば法的なツールを開発する。個別の事例から得られた知見は、抽象化され形式知となり、次のプロジェクトのリーガルデザインに活用されていく。法的な事項に関して、こうした創造的なデザインが求められます。プロジェクトにさまざまな立場の人々が関わる場合、いずれかのメリットにのみ目を向けるのではなく、それぞれの創造性を高めるよう注意を払います。  
